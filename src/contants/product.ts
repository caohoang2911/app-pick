export const PRODUCT_PICKED_ERROR_TYPES = {
  ...
  NEAR_EXPIRY_DATE_NOT_YET_DISCOUNT_STAMPED: 'NEAR_EXPIRY_DATE_NOT_YET_DISCOUNT_STAMPED',
  EXPIRED_ONLINE_SALE_DATE_NOT_YET_DISCOUNT_DATE: 'EXPIRED_ONLINE_SALE_DATE_NOT_YET_DISCOUNT_DATE',
...
export const PRODUCT_PICKED_ERROR_TYPE_LABELS = {
  ...
  [PRODUCT_PICKED_ERROR_TYPES.NEAR_EXPIRY_DATE_NOT_YET_DISCOUNT_STAMPED]: 'SP cận hạn sử dụng, chưa dán tem giảm giá',
  [PRODUCT_PICKED_ERROR_TYPES.EXPIRED_ONLINE_SALE_DATE_NOT_YET_DISCOUNT_DATE]: 'SP quá hạn bán online, chưa đến hạn giảm giá',
  [PRODUCT_PICKED_ERROR_TYPES.INCORRECT_ORDERED_WEIGHT]: 'Sai cân nặng đặt hàng',
} as const;
...
export const PRODUCT_ACTION_LABELS = {
  ...
  [PRODUCT_ACTIONS.EXPIRED_ONLINE]: 'SP quá hạn bán online, chưa đến hạn giảm giá',
