    ...
    try {
      ...
      if (canOpen) {
        ...
        if (url.startsWith('apppick://')) {
          console.error('The apppick:// scheme could not be opened. This might indicate it\'s not properly registered in the app configuration.');
        }
      }
    } catch (error) {
      ...
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.devInfo}>
            ...
            Scheme: apppick{'\n'}
            Bundle ID: {Platform.OS === 'ios' ? 'com.caohoang2911.seedcom-app-pick' : 'com.caohoang2911.AppPick'}
          </Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>App Links (apppick://)</Text>
