...
const BookAhamoveActionsBottomsheet = forwardRef<any, Props>(({}, ref) => {
          ...
          {({ setFieldValue, handleSubmit, values }) => (
            <View className="px-4 py-4">
              <View className="flex gap- mb-2">
                ...
                >
                  <RadioButtonItem
                    value={scheduleType.ORDER_DELIVERY_TIME}
                    label={
                      <Text className="pl-3">Giao theo giờ khách chọn</Text>
                    }
                  />
                  <View className="py-3" />
                  <RadioButtonItem
              ...
              <View className="flex gap-2 mb-2">
                ...
                >
                  <RadioButtonItem
                    value={'SGN-BIKE'}
                    label={
                      <Text className="pl-3">Tài xế Ahamove (Siêu tốc)</Text>
                    }
                  />
                  <View className="py-3" />
                  <RadioButtonItem
