...
const BookShipperActionsBottomsheet = forwardRef<any, Props>(
  function BookShipperActionsBottomsheet(_props, ref) {
    ...
    const shippingServiceTypesFiltered = useMemo(() => {
      const types = config?.shippingServiceTypes || [];
      return types.filter((serviceType) => serviceType.id !== 'STORE_EMPLOYEE');
    }, [config?.shippingServiceTypes]);
