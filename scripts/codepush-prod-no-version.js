...
try {
  ...
  execSync('eas update --branch production --message "CodePush update without version increment"', { stdio: 'inherit' });
  
  console.log('✅ CodePush production deployment completed (no version change)!');
} catch (error) {
